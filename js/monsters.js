...
var allMonsterTypes = [
    ...
    new MonsterType ({
        name: 'cackling din',
        attack: [2,0,5,0,0,1,],
        defense: [12,12,11,5,12,0,],
        hitpoints: 20,
        level: 3,
        info: 'A horrible roaring laugh that rings out across the room from no clear source, producing a physical crushing effect.',
    }),
    new MonsterType ({
        name: 'rock worm',
        attack: [0,0,3,5,0,0,],
        defense: [7,0,7,11,11,0,],
        hitpoints: 20,
        level: 3,
        info: 'A horse-sized earthworm rips into the room, its groping prostomium dripping with acid slime and insatiably seeking food to pull back into its slurping throat.',
    }),
    new MonsterType ({
        name: 'mage\'s head',
        attack: [0,0,0,2,2,6,],
